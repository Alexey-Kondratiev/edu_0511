...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\nМеня зовут "+gosha.getName()+" "+gosha.getLastname()+"\nИмя моей мамы:  "+gosha.getMother().getName()+"\nИмя моего папы: "+gosha.getFather().getName()+"\nУ меня две бабушки,\nбабушка "+gosha.getMother().getMother().getName()+" и бабушка "+gosha.getFather().getMother().getName()+"\nУ меня два дедушки,\nдедушка "+gosha.getFather().getFather().getName()+" и дедушка "+gosha.getMother().getFather().getName());
